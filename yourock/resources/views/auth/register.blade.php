...
<script type="text/javascript">
        var citiesByProvince = {
            Albacete: ["hola","hola2"],
            Alicante: ["Alicante","Benidorm","Elche","Alicante","Denia","Torrevieja","Jávea","Orihuela","Alcoy","Calpe","Villajoyosa","Villena","Altea","Elda","Benisa","Santa Pola","San Juan de Alicante","Guardamar del Segura","Campello","Petrel","Guadalest","Teulada","San Vicente del Raspeig","Castalla","Jijona","Crevillente","Novelda","Alfaz del Pi","Rojales","Concentaina","Jalón","Pego","Muchamiel","Almoradí","San Fulgencio","Pilar de la Horadada","Aspe","Sax","Ibi","La Nucia","Biar","Salinas","Muro de Alcoy","Agost","Busot","Bañeres","Monóvar","Callosa de Ensarriá","Callosa de Segura","Elda","Dolores","Adsubia","Monforte del Cid"]
        }
